...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> updateEmployee(@RequestBody Employee emp)throws InsertionException {
        return new ResponseEntity<Employee>(services.updateEmployee(emp), HttpStatus.OK);
    }
    
    
    @ExceptionHandler(Exception.class)
    public ResponseEntity<Object> handleRuntimeException(HttpRequest request, Exception ex){
